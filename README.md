...
Los archivos que son propios de cada ejercicio, los voy a dejar rellenos con un ejercicio muy simple. La solución que cumple todo la dejo por aquí:
# Leer valores de x y y
x = float(input("x:"))
y = float(input("y:"))

# Calcular la expresión usando y**0.5 en lugar de math.sqrt
