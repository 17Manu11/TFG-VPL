...
"""
    ...
    system_msg = (
        ...
        "Ajuste a código base: si 'CÓDIGO BASE' está vacío, indícalo. Si existe,\n"
        "comprueba si el código del alumno se ajusta al código base y cita faltas concretas.\n\n"
        ...
        "- Ajuste al código base (cita faltas si las hay).\n"
        ...
        "   ajuste al código base y legibilidad/estilo. Cualquier 'No cumple' debe\n"
